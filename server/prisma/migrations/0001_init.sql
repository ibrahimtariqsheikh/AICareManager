...
-- CreateIndex
CREATE INDEX "Announcement_agencyId_idx" ON "Announcement"("agencyId" ASC);

-- CreateIndex
CREATE INDEX "Announcement_publishDate_idx" ON "Announcement"("publishDate" ASC);

-- CreateIndex
CREATE INDEX "Announcement_status_idx" ON "Announcement"("status" ASC);

-- CreateIndex
CREATE INDEX "AuditLog_agencyId_idx" ON "AuditLog"("agencyId" ASC);

-- CreateIndex
CREATE INDEX "AuditLog_entityType_entityId_idx" ON "AuditLog"("entityType" ASC, "entityId" ASC);

-- CreateIndex
CREATE INDEX "AuditLog_performedAt_idx" ON "AuditLog"("performedAt" ASC);

-- CreateIndex
CREATE INDEX "AuditLog_userId_idx" ON "AuditLog"("userId" ASC);

-- CreateIndex
CREATE INDEX "Certification_agencyId_idx" ON "Certification"("agencyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "ClientCareAssignment_clientId_userId_key" ON "ClientCareAssignment"("clientId" ASC, "userId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "CommunicationPreference_userId_key" ON "CommunicationPreference"("userId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Invitation_email_key" ON "Invitation"("email" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Invitation_token_key" ON "Invitation"("token" ASC);

-- CreateIndex
CREATE INDEX "MedicationAdministration_administeredById_idx" ON "MedicationAdministration"("administeredById" ASC);

-- CreateIndex
CREATE INDEX "MedicationAdministration_medicationRecordId_idx" ON "MedicationAdministration"("medicationRecordId" ASC);

-- CreateIndex
CREATE INDEX "MedicationRecord_clientId_idx" ON "MedicationRecord"("clientId" ASC);

-- CreateIndex
CREATE INDEX "MedicationRecord_medicationId_idx" ON "MedicationRecord"("medicationId" ASC);

-- CreateIndex
CREATE INDEX "MedicationRecord_userId_idx" ON "MedicationRecord"("userId" ASC);

-- CreateIndex
CREATE INDEX "MileageRecord_agencyId_idx" ON "MileageRecord"("agencyId" ASC);

-- CreateIndex
CREATE INDEX "MileageRecord_clientId_idx" ON "MileageRecord"("clientId" ASC);

-- CreateIndex
CREATE INDEX "MileageRecord_userId_idx" ON "MileageRecord"("userId" ASC);

-- CreateIndex
CREATE INDEX "Notification_userId_idx" ON "Notification"("userId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "OperatingHours_agencyId_dayOfWeek_key" ON "OperatingHours"("agencyId" ASC, "dayOfWeek" ASC);

-- CreateIndex
CREATE INDEX "OperatingHours_agencyId_idx" ON "OperatingHours"("agencyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Profile_userId_key" ON "Profile"("userId" ASC);

-- CreateIndex
CREATE INDEX "Schedule_agencyId_idx" ON "Schedule"("agencyId" ASC);

-- CreateIndex
CREATE INDEX "Schedule_clientId_date_idx" ON "Schedule"("clientId" ASC, "date" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Schedule_userId_clientId_date_startTime_endTime_key" ON "Schedule"("userId" ASC, "clientId" ASC, "date" ASC, "startTime" ASC, "endTime" ASC);

-- CreateIndex
CREATE INDEX "Schedule_userId_date_idx" ON "Schedule"("userId" ASC, "date" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "User_cognitoId_key" ON "User"("cognitoId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "User_email_key" ON "User"("email" ASC);

-- CreateIndex
CREATE INDEX "_AnnouncementAcknowledgements_B_index" ON "_AnnouncementAcknowledgements"("B" ASC);
