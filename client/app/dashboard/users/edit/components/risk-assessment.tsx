...
import { Plus, Trash2, AlertTriangle, Shield, FileText, Calendar, User } from "lucide-react"
...
export default function RiskAssessment() {
    ...
    const updateRisk = (id: number, field: keyof Risk, value: Risk[keyof Risk]) => {
    ...
    const updateReview = (id: number, field: keyof Review, value: Review[keyof Review]) => {
