...
export default function PricingPage() {
    ...
    const plansData = [
        {
            ...
            features: [
                ...
                "Simple messaging for your team",
        ...
        },
        {
            ...
            features: [
                ...
                "Family chat bot for easy communication",
        ...
        },
        {
            ...
            features: [
                ...
                "Advanced AI chat bot for families",
                "Custom dashboards for your team",
                "White-labeling with your branding",
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Yes, we use healthcare-grade security to protect all your sensitive information.",
        },
        {
            question: "Do you offer training?",
            answer: "Yes, we provide training for all plans. Enterprise plans include personalized training sessions.",
        },
        {
            question: "How does the family chat bot work?",
            answer:
                "The chat bot answers common questions from families about their loved one's care, saving your staff time.",
        },
    ]
