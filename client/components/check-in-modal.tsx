...
import { closeCheckInModal } from "@/state/slices/medicationSlice"
...
export function CheckInModal() {
    ...
    const [recordAdministration] = api.useRecordMedicationAdministrationMutation()
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const formattedDay = selectedDay < 10 ? `0${selectedDay}` : selectedDay.toString()
        const date = `${selectedYear}-${Number.parseInt(selectedMonth) + 1}-${formattedDay}`
